 <div class="header">
    ...
    <div class="menu">                
        ...
        <ul class="navigation">
        	<li>
	            <a href="<?= base_url('admincp/code').'.html'; ?>">
	                <span class="isw-archive"></span><span class="text">Mã giảm giá</span>
	            </a>
	        </li>
            <li>
            ...
            <?php }else { ?>
	            ...
	            <li>
	             ...
	             <li>
	                <a href="<?= base_url('admincp/promotion.html'); ?>">
	                    <span class="isw-archive"></span><span class="text">QL Khuyến mãi</span>
	                </a>
	            </li>      
            <?php }?>         
