                                    ...
                                    <div class="row-form1 titlenameimglink">
                                    	...
                                    	<div style="float: left; width: 100%;" id="waptitlenameimglink">
                                    		...
                                    		<div class="span5">
	                                    		...
	                                    		<input type="text" placeholder="Nhập ảnh" size="60" name="titlenameimglink3[]" id="titlenameimglink3<?php echo $i;?>" value="<?php echo $json_decode_namelink->titlenameimglink3; ?>">
                                    		</div>
                                    		<div class="span1"></div>
                                    		<input type="button" value="xoa" class="btn btn-warning delbtn" id="deltitlenameimglink">
                                    		<input type="button" onclick="BrowseServer('Images:/','titlenameimglink3<?php echo $i;?>')" value="Browse Server" class="btn btn-info">
                                    	</div>
                                    	<?php $i++; } ?>
                                        <div class='clear'></div>
                                    </div>
