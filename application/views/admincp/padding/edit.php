					...
					<div class="block-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								...
								<label><input type="radio" name="type"  <?php if($info['type'] == 4){ echo "checked";}?> value="4" ></input>POPUP</label>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span3">
								<label><input type="radio" value="1" name="status" <?php if($info['status'] == 1){ echo "checked"; } ?>>Hiện</label>
								<label><input type="radio" value="2" name="status" <?php if($info['status'] == 2){ echo "checked"; } ?>>Ẩn</label>
							</div>
							<div class="clear"></div>
						</div>	
