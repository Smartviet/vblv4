					...
					<div class="block-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								...
								<label><input type="radio" name="type" value="4" ></input>POPUP</label>
							</div>
							<div class="clear"></div>
						</div>
						<div class="row-form">
						...
						<div class="row-form">
							...
							<div class="span3">
								<label><input type="radio" checked="" value="1" name="status">Hiện</label>
								<label><input type="radio" value="2" name="status">Ẩn</label>
							</div>
							<div class="clear"></div>
						</div>
