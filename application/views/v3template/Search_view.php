     	...
     	<div class="type-filter all-product">
            ...
            <div class="content-filter">
                ...
                <?php if (isset($_GET['lefprice']) && $_GET['lefprice'] != 0){ ?>
                	 <ul id="root_tree"  class="filter-group">
	                    <?php echo $_GET['lefprice'].' <span style="color:#ff0000;">đến</span> '.$_GET['rightLabel']; ?>
    ...
    <article id="content-page">
        ...
        <div id="main-content">
            <div class="task-main-content">
                <h1 class="title-main-content"> <?php
                                                if($this->input->post()){
            ...
            <div class="main-content-inner">
                ...
                <div class="product-item">
                    ...
                    <div class="img-product-item">
                        <a href="<?php echo base_url($getAllProduct['seo_name']); ?>.html"><img src="<?php echo base_url($getAllProduct['productImage']); ?>" alt="Tên sản phẩm" title="Tên sản phẩm"></a>
                    </div>
					...
					<div class="product-mask">
                        <span>-<?= $getAllProduct['giamgia'] ?>%</span>
                    </div>
					<?php } ?>
