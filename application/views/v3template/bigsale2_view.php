    ...
    <article class="main-sale">
        ...
        <div class="main-sale-product">
            <div class="show-main-sale-product">
                ...
                <div id="main-slider">
                    <ul id="demo1">
                        <li><a href="#"><img src="<?php echo base_url('assets');?>/img/slider-sale/1.jpg" alt="Tiêu đề bài viết"></a></li>
                        <li><a href="#"><img src="<?php echo base_url('assets');?>/img/slider-sale/2.jpg" alt="Tiêu đề bài viết"></a></li>
                        <li><a href="#"><img src="<?php echo base_url('assets');?>/img/slider-sale/3.jpg" alt="Tiêu đề bài viết"></a></li>
                        <li><a href="#"><img src="<?php echo base_url('assets');?>/img/slider-sale/4.jpg" alt="Tiêu đề bài viết"></a></li>
                    </ul>
        	...
        	<?php if($getProductPromotion["typePromotion"] == 1){ ?>
        		<div class="product-sale-item-type-1">
	                ...
	                <?php if($getProductPromotion['ghod'] != null){ ?>
						<div class="place">Giao hàng tại <?= $productdetail->ghod ?></div>
					<?php }else { ?>
