...
<section id="main-page">
    <aside id="filter">
        ...
        <!--<img class="lazy" src="filter.jpg" width="100%">-->
    </aside><!--End Filter-->
    ...
    <article id="content-page">
            ...
            <?php $child = 1; foreach ($getCateUris as $getCateUriChild):?>
                <div class="child-category-item <?php if(($child % 4)==0){ echo "last";} ?>">
                    <div class="img-child-category-item">
                        <a href="<?php echo $getCateUriChild['keypage'];?>"><img class="lazy" data-original="<?php if($getCateUriChild['catImage'] != ""){ echo base_url($getCateUriChild['catImage']); }else { echo base_url('public/font-end/images').'/imgdanhmuc.jpg'; } ?>"  src="<?php echo base_url('assets/2015/js/loading.gif');?>" alt="<?php echo $getCateUriChild['catName'];?>" title="<?php echo $getCateUriChild['catName'];?>"></a>
                    </div>
        ...
        <div id="main-content">
            <div class="task-main-content">
                <h1 class="title-main-content"><?php echo $getCategoryDetail->catName; ?></h1>
                ...
                <?php foreach ($getProdUsingCates as $getProdUsingCate): ?>
                    <div class="product-item">
                        <div class="img-product-item">
                            <a href="<?php echo base_url($getProdUsingCate['seo_name']); ?>.html"><img class="lazy" data-original="<?php echo base_url($getProdUsingCate['productImage']); ?>" alt="<?php echo $getProdUsingCate['productName'];?>"  src="<?php echo base_url('assets/2015/js/loading.gif');?>" alt="<?php echo $getProdUsingCate['productName'];?>" title="<?php echo $getProdUsingCate['productName'];?>"></a>
                        </div>
                        ...
                        <div class="product-price">
                            ...
                            <div class="small-info">
                                <span class="count-view" title="Lượt xem sản phẩm" style="cursor: help"><?php if($getProdUsingCate['view'] != ""){ echo  @$getProdUsingCate['view']; } ?></span><br>
                        <span class="local-ship" title="Địa điểm giao hàng" style="cursor: help"><?php if($getProdUsingCate['ghod'] != null){ ?>
                                <?= $getProdUsingCate['ghod'] ?>
                            <?php }else { ?>
                                Toàn Quốc
                            <?php }?></span>
                            </div>
