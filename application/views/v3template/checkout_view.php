...
var google_conversion_label = "fqZgCOqVrloQq5ap1wM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/988433195/?label=fqZgCOqVrloQq5ap1wM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
        ...
        <div class="login-register">
            ...
            <div class="tab_container_main">
                ...
                <div id="tab2" class="tab_content">
                    <div class="register">
                    	<form id="checkout" action="<?php echo base_url().'checkout/step2';?>" method="post">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>Mã giảm giá</td>
                                <td>
                                <input name="code" id="code" class="code" type="text"  placeholder="Nếu có mã giảm giá bạn nhập vào đây" >
                                </td>
                                <td><div class="error1"><?php echo form_error('code'); ?></div></td>
                            </tr>
