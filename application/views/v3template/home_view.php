...
<div class="cookie-popup-wrap" style="display: none">
		<div class="cookie-popup">
            <a href="<?php echo $getPopup->url; ?>">
                <img src="<?php echo base_url($getPopup->image); ?>" alt="Khuyến mại" title="Khuyến mại">
            </a>
    ...
    <div id="slider-inner">
        ...
        <div id="right-advertise-slider">
	    	...
	    	$(document).ready(function(){
	    		$('#yourImg<?php echo $padding['id']; ?>').bttrlazyloading();
	        });
	    	</script>
            <div class="advertise-item">
                <a href="<?php echo $padding['url']; ?>">
                <img id="yourImg<?php echo $padding['id']; ?>" 
                class="bttrlazyloading" data-bttrlazyloading-sm-src="<?php echo base_url($padding['image']);?>" src="<?php echo base_url($padding['image']);?>" alt="Quảng cáo">
                </a>
