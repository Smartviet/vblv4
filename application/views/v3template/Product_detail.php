...
<section id="main-page">
    <article id="content-product-detail">
                ...
                <div class="short-description">
                    <ul>
                        <?php if($productdetail->thongso != ''){
                            ...
                            <?php }  ?>
                            <?php if($productdetail->weight != ""){ ?>
                                <li><span>Khối lượng : <?= @$productdetail->weight ?></span></li>
                            <?php }  ?>
        ...
        <div class="more-product-info">
            ...
            <ul class="tabs">
                <li class="active" rel="tab1"><a>Chi tiết sản phẩm</a></li>
                <li rel="tab2"><a href="#thongtinsanpham">Thông tin sản phẩm</a></li>
                <li rel="tab3"><a href="#nhanxet">Nhận xét của khách hàng</a></li>
            </ul>

            <div class="tab_container">

                <div id="tab1" class="tab_content">
                    <h2 class="title-tab-content"><?= $productdetail->productName ?></h2>
        ...
        </div><!--End More Product Info-->

        <div class="more-product-info">
            <div id="thongtinsanpham"></div>

            <div class="tab_container no-line">
                ...
                <div class="buynow-button">
                    <div class="buynow-button-inner">
                        <h3 class="name-product"><?php echo $productdetail->productName ?></h3>
                        <div class="thumb"><img src="<?= $productdetail->productImage ;?>"></div>
        ...
        <div class="more-product-info">
            <div id="nhanxet"></div>
            <ul class="tabs tabs2">
                <li rel="tab3"><a>Nhận xét của khách hàng</a></li>
            </ul>
